...
const TABLE_HEAD = [
     ...
     // { id : "isPublished" , label : "موجودی" , alignRight : false } ,
     { id : "categories" , label : "دسته بندی" , alignRight : false } ,
     // { id: 'isPublished', label: 'دسته بندی', alignRight: false },
                                             ...
                                             { filteredProducts.slice( page * rowsPerPage , page * rowsPerPage + rowsPerPage ).map( ( row ) => {
                                                  ...
                                                  return (
                                                       ...
                                                       >
                                                            ...
                                                            {/*           <TableCell
                                                             style = { { minWidth : 160 } } >{ moment( createdAt ).format( "jYYYY/jMM/jDD" ) }</TableCell >
                                                             ...
                                                             >
                                                             { status === 0 ? ` موجودی نداریم` : status < 5 ? "موجودی کم است" : status }
                                                             </Label >
                                                             </TableCell >*/ }
